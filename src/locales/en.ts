...
export const en: Messages = {
  ...
  relationHints: {
    ...
    crush:
      "You're in a flirting stage: some mutual interest, but nothing said outright yet",
    pursuing:
